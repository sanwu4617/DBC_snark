...
int t_right[MAX_2];
int t_left[MAX_2];
//variables.cpp�м�������3���������滻��init����
unsigned int w_min0[4];    //b,t,v,mode������mode=0�������ƣ�mode=1��w(b,t)+2^b3^t��mode=2��w(b,t)��mode=3��w_(b,t)+2^b3^t
unsigned short w_rec[MAX_2][MAX_3][3];
int MAX_T;
double d_pow23[MAX_2][MAX_3];
uint288 u_pow23[MAX_2][MAX_3];
__host__ __device__ void init(int down_mode)
{
    //为DBC代码运行提供基础环境
	pow2[0] = 1;
	pow3[0] = 1;
